...
#4 sum of first 30 even numbers
def number():
    sum=0
    for i in range(1,31):
        if i%2==0:
...
count("my name is Abhinay and iam learning python programming language")
...
l=[1,2,3,44,1,68,23,3,89,56,68,3,1,2]
def num():
    a=set(l)
    b=list(a)
    print(b)
...
name="my name is Abhinay and iam learning python programming language"
def words():
    a=name.count(" ")
    print(a+1)
words()
